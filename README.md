This repository contains SQL exercises and analysis using the Chinook database.
...
📌 This project is part of my transition into more data-focused roles, strengthening my SQL and data analysis capabilitie
